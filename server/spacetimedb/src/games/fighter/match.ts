...
function toState(r: any): FighterState {
  return {
    ...
    stunFrames: r.stunFrames, stamina: r.stamina, staminaCd: r.staminaCd, attackCd: r.attackCd,
...
function withState(row: any, s: FighterState): any {
  return {
    ...
    stunFrames: s.stunFrames, stamina: s.stamina, staminaCd: s.staminaCd, attackCd: s.attackCd,
